...
var panelContent = {
    ...
    pane: '<br><p id="sidebar-content"></p><br><img src="$('#myimage').text(e.target.feature.properties.myimage"><br><br><p id="sidebar-content2"></p><br><p id="sidebar-content3"></p><br><p id="sidebar-content4"></p><br><p id="sidebar-comments"></p>',    // Content of the panel. DOM elements can be passed, too.
